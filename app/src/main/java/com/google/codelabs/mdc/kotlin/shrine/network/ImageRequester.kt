...
/**
 * Kelas yang menangani permintaan gambar menggunakan Volley.
 */
object ImageRequester {
    ...
    /**
     * Menyetel gambar pada [NetworkImageView] yang diberikan ke gambar di URL yang diberikan
     *
     * @param networkImageView [NetworkImageView] untuk mengaktifkan gambar
     * URL url @param dari gambar
     */
